...
var (
	ABI    = "[{\"type\":\"function\",\"name\":\"hash\",\"inputs\":[{\"name\":\"nonceProof\",\"type\":\"bytes\",\"internalType\":\"bytes\"}],\"outputs\":[{\"name\":\"\",\"type\":\"bytes32\",\"internalType\":\"bytes32\"}],\"stateMutability\":\"view\"},{\"type\":\"function\",\"name\":\"verify\",\"inputs\":[{\"name\":\"pubKey\",\"type\":\"bytes\",\"internalType\":\"bytes\"},{\"name\":\"pi\",\"type\":\"bytes\",\"internalType\":\"bytes\"},{\"name\":\"m\",\"type\":\"bytes\",\"internalType\":\"bytes\"}],\"outputs\":[{\"name\":\"\",\"type\":\"bool\",\"internalType\":\"bool\"}],\"stateMutability\":\"view\"}]"
	Abi, _ = abi.JSON(strings.NewReader(ABI))
)

func (c *VRF) Run(input []byte) (ret []byte, err error) {
	defer func() {
		if r := recover(); r != nil {
			switch e := r.(type) {
			case error:
...
func (c *VRF) initMethodEntry() {

	methodEntry := map[string]func([]byte) ([]byte, error){
		"aa1e84de": c.HashEntry,
		"de8f50a1": c.VerifyEntry,
	}
	V0 := uint64(0)
	c.methodEntries[V0] = methodEntry

}
func (c *VRF) loadMethodABI() error {
...
func (c *VRF) GetCreateBlock() uint64 {
...
func (c *VRF) HashEntry(input []byte) ([]byte, error) {

	method := c.abi.Methods["hash"]
	...
	res0, err := c.Hash(*abi.ConvertType(args[0], new([]byte)).(*[]byte))
	if err != nil {
...
func (c *VRF) VerifyEntry(input []byte) ([]byte, error) {

	method := c.abi.Methods["verify"]
	...
	res0, err := c.Verify(*abi.ConvertType(args[0], new([]byte)).(*[]byte), *abi.ConvertType(args[1], new([]byte)).(*[]byte), *abi.ConvertType(args[2], new([]byte)).(*[]byte))
	if err != nil {
		if r, ok := err.(*typesdk.RevertError); ok {
			return r.ReturnData, vm.ErrExecutionReverted
		}
