...
// Contract is an auto generated Go binding around an platon contract.
...
// ContractCaller is an auto generated read-only Go binding around an platon contract.
type ContractCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ContractTransactor is an auto generated write-only Go binding around an platon contract.
type ContractTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ContractFilterer is an auto generated log filtering Go binding around an platon contract events.
type ContractFilterer struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ContractSession is an auto generated Go binding around an platon contract,
...
// ContractCallerSession is an auto generated read-only Go binding around an platon contract,
...
// ContractTransactorSession is an auto generated write-only Go binding around an platon contract,
...
// ContractRaw is an auto generated low-level Go binding around an platon contract.
type ContractRaw struct {
	Contract *Contract // Generic contract binding to access the raw methods on
}

// ContractCallerRaw is an auto generated low-level read-only Go binding around an platon contract.
type ContractCallerRaw struct {
	Contract *ContractCaller // Generic read-only contract binding to access the raw methods on
}

// ContractTransactorRaw is an auto generated low-level write-only Go binding around an platon contract.
...
// Drawing is a paid mutator transaction binding the contract method 0xb77200b1.
//
// Solidity: function drawing() returns()
func (_Contract *ContractTransactor) Drawing(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "drawing")
}

// Drawing is a paid mutator transaction binding the contract method 0xb77200b1.
//
// Solidity: function drawing() returns()
func (_Contract *ContractSession) Drawing() (*types.Transaction, error) {
	return _Contract.Contract.Drawing(&_Contract.TransactOpts)
}

// Drawing is a paid mutator transaction binding the contract method 0xb77200b1.
//
// Solidity: function drawing() returns()
func (_Contract *ContractTransactorSession) Drawing() (*types.Transaction, error) {
	return _Contract.Contract.Drawing(&_Contract.TransactOpts)
}

// Guessing is a paid mutator transaction binding the contract method 0x3ae7358d.
//
// Solidity: function guessing(uint256 number) returns()
func (_Contract *ContractTransactor) Guessing(opts *bind.TransactOpts, number *big.Int) (*types.Transaction, error) {
	return _Contract.contract.Transact(opts, "guessing", number)
}

// Guessing is a paid mutator transaction binding the contract method 0x3ae7358d.
//
// Solidity: function guessing(uint256 number) returns()
func (_Contract *ContractSession) Guessing(number *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Guessing(&_Contract.TransactOpts, number)
}

// Guessing is a paid mutator transaction binding the contract method 0x3ae7358d.
//
// Solidity: function guessing(uint256 number) returns()
func (_Contract *ContractTransactorSession) Guessing(number *big.Int) (*types.Transaction, error) {
	return _Contract.Contract.Guessing(&_Contract.TransactOpts, number)
}
...
// ContractDrawingIterator is returned from FilterDrawing and is used to iterate over the raw logs and unpacked data for Drawing events raised by the Contract contract.
type ContractDrawingIterator struct {
	Event *ContractDrawing // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractDrawingIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractDrawingIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractDrawingIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractDrawing represents a Drawing event raised by the Contract contract.
type ContractDrawing struct {
	Owner  common.Address
	Number *big.Int
	Nonce  *big.Int
	Bonus  *big.Int
...
// FilterDrawing is a free log retrieval operation binding the contract event 0x696d5367e8a6c822e93ca923e1eac0acf5433369e16d9db3824dc11bfa2e085f.
//
// Solidity: event Drawing(address owner, uint256 number, uint256 nonce, uint256 bonus)
func (_Contract *ContractFilterer) FilterDrawing(opts *bind.FilterOpts) (*ContractDrawingIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "Drawing")
	if err != nil {
		return nil, err
	}
	return &ContractDrawingIterator{contract: _Contract.contract, event: "Drawing", logs: logs, sub: sub}, nil
}

// WatchDrawing is a free log subscription operation binding the contract event 0x696d5367e8a6c822e93ca923e1eac0acf5433369e16d9db3824dc11bfa2e085f.
//
// Solidity: event Drawing(address owner, uint256 number, uint256 nonce, uint256 bonus)
func (_Contract *ContractFilterer) WatchDrawing(opts *bind.WatchOpts, sink chan<- *ContractDrawing) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "Drawing")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractDrawing)
				if err := _Contract.contract.UnpackLog(event, "Drawing", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseDrawing is a log parse operation binding the contract event 0x696d5367e8a6c822e93ca923e1eac0acf5433369e16d9db3824dc11bfa2e085f.
//
// Solidity: event Drawing(address owner, uint256 number, uint256 nonce, uint256 bonus)
func (_Contract *ContractFilterer) ParseDrawing(log types.Log) (*ContractDrawing, error) {
	event := new(ContractDrawing)
	if err := _Contract.contract.UnpackLog(event, "Drawing", log); err != nil {
		return nil, err
	}
...
// ContractGuessingIterator is returned from FilterGuessing and is used to iterate over the raw logs and unpacked data for Guessing events raised by the Contract contract.
type ContractGuessingIterator struct {
	Event *ContractGuessing // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *ContractGuessingIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *ContractGuessingIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *ContractGuessingIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// ContractGuessing represents a Guessing event raised by the Contract contract.
type ContractGuessing struct {
	Owner  common.Address
	Number *big.Int
	Raw    types.Log // Blockchain specific contextual infos
}

// FilterGuessing is a free log retrieval operation binding the contract event 0x1506736cb302149d691074ef1881cc011675c4737d3fa169ab3aa0fc74c2030c.
//
// Solidity: event Guessing(address owner, uint256 number)
func (_Contract *ContractFilterer) FilterGuessing(opts *bind.FilterOpts) (*ContractGuessingIterator, error) {

	logs, sub, err := _Contract.contract.FilterLogs(opts, "Guessing")
	if err != nil {
		return nil, err
	}
	return &ContractGuessingIterator{contract: _Contract.contract, event: "Guessing", logs: logs, sub: sub}, nil
}

// WatchGuessing is a free log subscription operation binding the contract event 0x1506736cb302149d691074ef1881cc011675c4737d3fa169ab3aa0fc74c2030c.
//
// Solidity: event Guessing(address owner, uint256 number)
func (_Contract *ContractFilterer) WatchGuessing(opts *bind.WatchOpts, sink chan<- *ContractGuessing) (event.Subscription, error) {

	logs, sub, err := _Contract.contract.WatchLogs(opts, "Guessing")
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(ContractGuessing)
				if err := _Contract.contract.UnpackLog(event, "Guessing", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseGuessing is a log parse operation binding the contract event 0x1506736cb302149d691074ef1881cc011675c4737d3fa169ab3aa0fc74c2030c.
//
// Solidity: event Guessing(address owner, uint256 number)
func (_Contract *ContractFilterer) ParseGuessing(log types.Log) (*ContractGuessing, error) {
	event := new(ContractGuessing)
	if err := _Contract.contract.UnpackLog(event, "Guessing", log); err != nil {
		return nil, err
	}
