module github.com/PlatONnetwork/AppChain-SDK

go 1.21.0

require (
	github.com/PlatONnetwork/PlatON-Go v1.2.0
...
replace github.com/PlatONnetwork/PlatON-Go => /home/yangzhou/platon/appchain-base/AppChain-Base
