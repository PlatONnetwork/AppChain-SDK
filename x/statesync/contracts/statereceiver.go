...
func (c *StateReceiver) EmitNewCommitmentEvent(startId *big.Int, endId *big.Int, root common.Hash) (*types.Log, error) {
	...
	data, err := event.Inputs.Pack(startId, endId, root)
	if err != nil {
		return nil, err
	}
	return &types.Log{
