...
func (c *StakeHandler) initMethodEntry() {
	...
	c.methodEntry = map[string]func([]byte) ([]byte, error){
		...
		"7cde4b2d": c.PendingWithdrawalsOfStakeEntry,
		"a315ebb6": c.WithdrawableOfDelegateEntry,
		"5bfabd3f": c.WithdrawableOfStakeEntry,
...
func (c *StakeHandler) PendingWithdrawalsOfStakeEntry(input []byte) ([]byte, error) {
	...
	res0, err := c.PendingWithdrawalsOfStake(*abi.ConvertType(args[0], new(common.Address)).(*common.Address), *abi.ConvertType(args[1], new(common.Address)).(*common.Address))
	if err != nil {
		if r, ok := err.(*typesdk.RevertError); ok {
			return r.ReturnData, vm.ErrExecutionReverted
		}
...
func (c *StakeHandler) WithdrawableOfStakeEntry(input []byte) ([]byte, error) {
	...
	res0, err := c.WithdrawableOfStake(*abi.ConvertType(args[0], new(common.Address)).(*common.Address), *abi.ConvertType(args[1], new(common.Address)).(*common.Address))
	if err != nil {
		if r, ok := err.(*typesdk.RevertError); ok {
			return r.ReturnData, vm.ErrExecutionReverted
		}
...
func (c *StakeHandler) EmitNewEpochEvent(id *big.Int, startBlock *big.Int, endBlock *big.Int, epochRoot common.Hash) (*types.Log, error) {
