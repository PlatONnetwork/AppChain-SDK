...
type StageModuler interface {
	...
	GetRoundByBlockNumber(stateDB sdk.StateDBReader, blockNumber uint64) uint64
	GetEpochByBlockNumber(stateDB sdk.StateDBReader, blockNumber uint64) uint64
	...
	IsEndOfRound(db sdk.StateDBReader, blockNumber uint64) bool
	IsEndOfEpoch(db sdk.StateDBReader, blockNumber uint64) bool
	...
	IsNotEndOfRound(db sdk.StateDBReader, blockNumber uint64) bool
	IsNotEndOfEpoch(db sdk.StateDBReader, blockNumber uint64) bool
